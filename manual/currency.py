...
class CurrencyConverter:
    ...
    def __init__(self, currency_country_map_fpath: str) -> None:
        """Initializes a new instance of a `CurrencyConverter`.

        Args:
            currency_country_map_fpath: The path to the currency country map file.
        ...
        with open(currency_country_map_fpath, encoding="utf-8") as f:
            self._currency_country_map = json.load(f)
