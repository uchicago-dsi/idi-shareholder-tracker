/**
 * Default configuration for investment list operations.
 */
export const INVESTMENT_LIST_CONFIG = Object.freeze({
  columns: [
    {
      key: "investor_name",
      label: "Investor",
...
export type InvestmentListConfig = typeof INVESTMENT_LIST_CONFIG;
